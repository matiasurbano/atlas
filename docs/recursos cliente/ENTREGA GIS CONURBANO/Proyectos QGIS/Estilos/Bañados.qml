...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="REGIMEN" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="NO PERMANENTE" label="Bañado no perenne"/>
      <category symbol="1" value="PERMANENTE" label="Bañado perenne"/>
    ...
    <symbols>
      ...
      <symbol alpha="0" type="fill" name="2">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_unit" v="MM"/>
          <prop k="color" v="230,68,82,255"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="NAVEGABILI"/>
    ...
    <edittype labelontop="0" editable="1" type="0" name="REGIMEN"/>
