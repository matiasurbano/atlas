...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="TIPO" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="PERMANENTE" label="Corrientede agua perenne"/>
      <category symbol="1" value="TEMPORARIO" label="Corrientede agua temporaria"/>
      <category symbol="2" value="TEMPORARIO2" label="Corrientede agua temporaria"/>
